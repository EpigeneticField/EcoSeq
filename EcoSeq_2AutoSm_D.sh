##EcoSeq_2AutoSm_D##
##./EcoSeq_2AutoSm_D.sh /Volumes/EcoSeq04/EcoSeqII_testFastq/source/hg38 sample.txt 4
##for EcoSeq(adaptorv1)
...
while read line; do
	...
	python ${S_DIR}/tag_to_header.py --infile1 ${NAME}_R1.fastq --infile2 ${NAME}_R2.fastq --outprefix ${line} --tagstats --spacerlen 4 --taglen 12 --filtspacer 'CGTC'
	...
	samtools sort -@ $TH -O bam -o ${NAME}.f5.uniq1.pe.sorted.bam ${NAME}.f5.uniq1.pe.bam
	...
	#python ${S_DIR}/ConsensusMaker.py --infile ${NAME}.f5.uniq1.pe.sorted.bam --tag_file ${NAME}.f5.uniq1.pe.tagcounts --tag_stats ${NAME}.f5.uniq1.pe.tagstats --outfile ${NAME}.f5.uniq1.sscs.bam --minmem 3 --read_length 129 --cut_off 0.7 --Ncut_off 0.3 --read_type dp --filt n
	python ${S_DIR}/ConsensusMaker.py --infile ${NAME}.f5.uniq1.pe.sorted.bam --tag_file ${NAME}.f5.uniq1.pe.tagcounts --tag_stats ${NAME}.f5.uniq1.pe.tagstats --outfile ${NAME}.f5.uniq1.sscs.bam --minmem 3 --read_length 129 --cut_off 0.7 --Ncut_off 0.3 --read_type dp --filt n
	samtools sort -@ $TH -O bam -o ${NAME}.f5.uniq1.sscs.sorted.bam ${NAME}.f5.uniq1.sscs.bam
	...
	#python ${S_DIR}/DuplexMaker.py --infile ${NAME}.f5.uniq1.sscs.sorted.bam --outfile ${NAME}.f5.uniq1.dcs.bam --Ncutoff 0.3 --readlength 129
	...
	python ${S_DIR}/DuplexMaker.py --infile ${NAME}.f5.uniq1.sscs.sorted.bam --outfile ${NAME}.f5.uniq1.dcs.bam --Ncutoff 0.3 --readlength 129
	fastp -i ${NAME}.f5.uniq1.dcs.r1.fq -I ${NAME}.f5.uniq1.dcs.r2.fq -o ${NAME}.f5an0.uniq1.dcs.r1.fq -O ${NAME}.f5an0.uniq1.dcs.r2.fq -h ${NAME}.f5an0.uniq1.dcs.report.html -a GGATCGACA -w $TH -n 0
	bwa mem -t $TH $REF ${NAME}.f5an0.uniq1.dcs.r1.fq ${NAME}.f5an0.uniq1.dcs.r2.fq > ${NAME}.f5an0.uniq1.dcs.aln.sam
	samtools sort -@ $TH -O bam -o ${NAME}.f5an0.uniq1.dcs.sorted.bam ${NAME}.f5an0.uniq1.dcs.aln.sam
	...
	Rscript ${S_DIR}/R_EcoSeq_DCS.R ${I_DIR} $line
